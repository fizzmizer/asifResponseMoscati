...
\begin{abstract}
    In a recent paper, Moscati provides an analysis of as-if modelling in economics. According to him, most of economical models---be it neoclassical, behavioural or heuristic---are as-if, and that should be no worry at all. That observation is then taken to be a reason to move forward a realist understanding of modelling and embrace a form of instrumentalism.
...
In a recent paper \cite{Moscati2023}
